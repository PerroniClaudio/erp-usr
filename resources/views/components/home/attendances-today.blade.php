                    ...
                    <tr>
                        ...
                        <td>
                            @switch($status['status'])
                                @case('registered')
                                    <div role="alert" class="alert alert-success alert-soft lg:w-2/3">
                                ...
                                @case('time_off')
                                    <div role="alert" class="alert alert-secondary alert-soft lg:w-2/3">
                                ...
                                @case('not_registered')
                                    <div role="alert" class="alert alert-error alert-soft lg:w-2/3">
