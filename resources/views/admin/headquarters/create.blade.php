<x-layouts.app>
    ...
    <div class="card bg-base-300">
        <form class="card-body flex flex-col gap-4" id="headquarter-form" data-headquarter-form method="POST"
            action="{{ route('headquarters.store') }}" data-search-url="{{ route('headquarters.search-address') }}">
            @csrf
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-4">
                <fieldset class="fieldset">
                    ...
                    <input type="text" name="name" class="input w-full" value="{{ old('name') }}"
                        placeholder="{{ __('headquarters.name') }}" />
                </fieldset>

                <fieldset class="fieldset">
                    <legend class="fieldset-legend">{{ __('headquarters.company') }}</legend>
                    <select class="select select-bordered w-full" name="company_id">
                        <option value="" disabled {{ old('company_id', $selectedCompanyId) ? '' : 'selected' }}>
                            {{ __('headquarters.select_company') }}</option>
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-2 gap-4 mt-2">
                        <fieldset class="fieldset">
                            ...
                            <input type="text" name="address" class="input w-full headquarter-address-field"
                                value="{{ old('address') }}" placeholder="{{ __('headquarters.address') }}"
                                disabled />
                        </fieldset>
                        ...
                        <fieldset class="fieldset">
                            ...
                            <input type="text" name="city" class="input w-full headquarter-address-field"
                                value="{{ old('city') }}" placeholder="{{ __('headquarters.city') }}" disabled />
                        </fieldset>
                        ...
                        <fieldset class="fieldset">
                            ...
                            <input type="text" name="province" class="input w-full headquarter-address-field"
                                value="{{ old('province') }}" placeholder="{{ __('headquarters.province') }}"
                                disabled />
                        </fieldset>
                        ...
                        <fieldset class="fieldset">
                            ...
                            <input type="text" name="zip_code" class="input w-full headquarter-address-field"
                                value="{{ old('zip_code') }}" placeholder="{{ __('headquarters.zip_code') }}"
                                disabled />
                        </fieldset>
                        ...
                        <fieldset class="fieldset">
                            ...
                            <input type="text" name="latitude" class="input w-full headquarter-address-field"
                                value="{{ old('latitude') }}" placeholder="{{ __('headquarters.latitude') }}"
                                disabled />
                        </fieldset>
                        ...
                        <fieldset class="fieldset">
                            ...
                            <input type="text" name="longitude" class="input w-full headquarter-address-field"
                                value="{{ old('longitude') }}" placeholder="{{ __('headquarters.longitude') }}"
                                disabled />
                        </fieldset>
                    </div>
                </div>
