<x-layouts.app>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-4 gap-4">
        <div class="flex flex-col gap-4 h-fit">
            <div class="card bg-base-300 ">
                <div class="card-body">
                    <h3 class="card-title">{{ __('time_off_requests.select_user_and_days') }}</h3>
                    <hr>
                    ...
                    <span class="text-error" id="user-error-field"></span>
                    ...
                    <button class="btn btn-success hidden" id="submit-button">
                        {{ __('time_off_requests.create_and_approve') }}
                    </button>
            ...
            <div role="alert" class="alert alert-info">
                ...
                <p>Le richieste create dagli admin vengono automaticamente approvate</p>
            </div>
    ...
    @push('scripts')
        @vite('resources/js/admin_time_off_requests.js')
    @endpush
