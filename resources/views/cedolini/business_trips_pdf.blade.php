...
<head>
    <meta charset="utf-8">
    <title>Nota spese - {{ $businessTrip->user->name }}</title>
    <style>
        body {
...
<body>
    ...
    <p>Il/La Sig./Sig.ra {{ $businessTrip->user->name }} è autorizzato/a ad effettuare il viaggio utilizzando il proprio
    ...
    <table>
        <tr>
            ...
            <td style="width: 50%;" class="card">
                ...
                <p><b>Nota spese n°: </b>{{ $businessTrip->code }}</p>
                <p><b>Del: </b>{{ \Carbon\Carbon::parse($document_date)->format('m/Y') }}</p>
